...
export class CarsComponent implements OnInit {
  ...
  _createForm(): void {
    this.form = new FormGroup({
      model: new FormControl(null, [Validators.required, Validators.minLength(2), Validators.maxLength(20)]),
      year: new FormControl(0, [Validators.required, Validators.minLength(0), Validators.maxLength(20)]),
      price: new FormControl(0,[Validators.required, Validators.minLength(0), Validators.maxLength(20)])
    })
  }
